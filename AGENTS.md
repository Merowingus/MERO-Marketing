...
The intelligence is **the Codex model**, not scripts. An agent = a **skill** (`.Codex/skills/<name>/SKILL.md`)
...
- **Agents live in** `.Codex/skills/` (invocable as `/<name>` in this project).
...
```
AGENTS.md            this file — how the project works
...
.Codex/skills/      the skill-agents (orchestrator, strategy-architect, + one per channel)
```
